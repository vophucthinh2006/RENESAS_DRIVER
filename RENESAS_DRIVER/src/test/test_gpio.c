...
static void test_port_index_invalid_returns_zero(void)
{
    /* Invalid port character: should return 0 (safe default) */
...
void test_gpio_register(void)
{
    ...
    test_register("gpio_port_index_invalid_zero",  test_port_index_invalid_returns_zero);
}
