...
| ID | File | Description | Status |
|----|------|-------------|--------|
| BUG-06 | `IIC.c:87-91` | I2C init: ICE set before IICRST, violates HW spec | ⬜ [[PHASE_3]] |
| BUG-07 | `IIC.c:113-114` | I2C_Start waits TEND after START → hangs forever | ⬜ [[PHASE_3]] |
| BUG-08 | `IIC.c:236-248` | ACK/NACK logic broken, ACKWP used incorrectly | ⬜ [[PHASE_3]] |
...
| ID | File | Description | Status |
|----|------|-------------|--------|
| BUG-10 | `GPIO.c:10` | Invalid port returns `0` (valid PORT0), no sentinel | ⬜ [[PHASE_4]] |
| BUG-11 | `GPIO.h:57-62` | GPIO_MODE_t has STM32 speed values, meaningless on RA6M5 | ⬜ [[PHASE_4]] |
| BUG-12 | `IIC.c:13-26` | I2C bypasses LPM_Unlock, directly writes MSTPCRB | ⬜ [[PHASE_3]] |
...
| ID | File | Description | Status |
|----|------|-------------|--------|
| BUG-14 | `IIC.h:36-56` | `I2C_PINCFG_t` and `I2C_ACK_t` declared but never used | ⬜ [[PHASE_3]] |
...
|----|-------------|--------|
| S-01 | `LPM.h` misnamed — contains MSTPCR, not LPM logic | ⬜ [[PHASE_5]] |
| S-02 | `SCI.h` has 70+ flat macros (10 ch × 7 reg) | ✅ Fixed — [[PHASE_2]] |
| S-03 | `CGC.c` is empty stub — clock never configured | ⬜ [[PHASE_6]] |
