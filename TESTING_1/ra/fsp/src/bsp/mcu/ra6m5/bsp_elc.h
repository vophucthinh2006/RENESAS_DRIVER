...
typedef enum e_elc_event_ra6m5
{
    ...
    ELC_EVENT_CAN_DMAREQ2                   = (0x05D), // RX fifo DMA request 2
    ELC_EVENT_CAN_DMAREQ3                   = (0x05E), // RX fifo DMA request 3
    ELC_EVENT_CAN_DMAREQ4                   = (0x05F), // RX fifo DMA request 4
    ELC_EVENT_CAN_DMAREQ5                   = (0x060), // RX fifo DMA request 5
    ELC_EVENT_CAN_DMAREQ6                   = (0x061), // RX fifo DMA request 6
    ELC_EVENT_CAN_DMAREQ7                   = (0x062), // RX fifo DMA request 7
